...
<template>
  <div class="auth-landing-page">
    <div class="bg-stars">
      <div class="home-hero mx-auto max-w-7xl px-4 relative">
        <div class="grid grid-cols-1 md:grid-cols-2 py-24">
          <div class="flex flex-col max-w-4xl md:mt-10 mx-auto pr-1/12 gap-6">
            <h1 class="text-4xl sm:text-6xl text-primary brightness-120">
            ...
            <div class="flex flex-col sm:flex-row justify-start items-start gap-4">
              <a href="https://app.feathers.dev" class="btn btn-primary btn-xl">Get Started</a>
              <a href="/auth/" class="btn btn-xl text-primary border border-primary border-solid">Documentation</a>
            </div>
          </div>
      ...
      <!-- Logos -->
      <div class="logos flex flex-col py-24 px-4 md:px-10 text-center bg-[#1c1735]/60 relative" role="region"
        aria-labelledby="auth-description">
        <p id="auth-description" class="text-balance text-xl mb-4">
          Secure and scalable authentication for NodeJS, Deno, Bun, Cloudflare Workers and local-first web-applications
        </p>
        <div class="mx-auto max-w-2xl lg:max-w-7xl" role="list" aria-label="Supported platforms">
          <div class="flex flex-wrap items-center justify-evenly mx-auto gap-y-4 gap-4 md:gap-8 lg:gap-16 mt-4 lg:mt-0">
            <a href="/auth/platforms/nodejs"
              class="border border-solid border-white/25 rounded-xl px-4 py-2 block transition-colors duration-200 hover:bg-white/10 flex items-center gap-3"
              role="listitem" aria-label="Use Cloud Auth with NodeJS">
            ...
            <a href="/auth/platforms/deno"
              class="border border-solid border-white/25 rounded-xl px-4 py-2 block transition-colors duration-200 hover:bg-white/10 flex items-center gap-3"
              role="listitem" aria-label="Use Cloud Auth with Deno">
            ...
            <a href="/auth/platforms/bun"
              class="border border-solid border-white/25 rounded-xl px-4 py-2 block transition-colors duration-200 hover:bg-white/10 flex items-center gap-3"
              role="listitem" aria-label="Use Cloud Auth with Bun">
            ...
            <a href="/auth/platforms/cloudflare"
              class="border border-solid border-white/25 rounded-xl px-4 py-2 block transition-colors duration-200 hover:bg-white/10 flex items-center gap-3"
              role="listitem" aria-label="Use Cloud Auth with Cloudflare Workers">
              <svg xmlns="http://www.w3.org/2000/svg" width="120.48" height="32" viewBox="0 0 512 136">
                <defs>
                  <linearGradient id="logosCloudflareWorkers0" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
                    <stop offset="0%" stop-color="#EB6F07" />
                    <stop offset="100%" stop-color="#FAB743" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers1" x1="81%" x2="40.5%" y1="83.7%" y2="29.5%">
                    <stop offset="0%" stop-color="#D96504" />
                    <stop offset="100%" stop-color="#D96504" stop-opacity="0" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers2" x1="42%" x2="84%" y1="8.7%" y2="79.9%">
                    <stop offset="0%" stop-color="#EB6F07" />
                    <stop offset="100%" stop-color="#EB720A" stop-opacity="0" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers3" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
                    <stop offset="0%" stop-color="#EE6F05" />
                    <stop offset="100%" stop-color="#FAB743" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers4" x1="-33.2%" x2="91.7%" y1="100%" y2="0%">
                    <stop offset="0%" stop-color="#D96504" stop-opacity=".8" />
                    <stop offset="49.8%" stop-color="#D96504" stop-opacity=".2" />
                    <stop offset="100%" stop-color="#D96504" stop-opacity="0" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers5" x1="50%" x2="25.7%" y1="100%" y2="8.7%">
                    <stop offset="0%" stop-color="#FFA95F" />
                    <stop offset="100%" stop-color="#FFEBC8" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers6" x1="8.1%" x2="96.5%" y1="1.1%" y2="48.8%">
                    <stop offset="0%" stop-color="#FFF" stop-opacity=".5" />
                    <stop offset="100%" stop-color="#FFF" stop-opacity=".1" />
                  </linearGradient>
                  <linearGradient id="logosCloudflareWorkers7" x1="-13.7%" x2="100%" y1="104.2%" y2="46.2%">
                    <stop offset="0%" stop-color="#FFF" stop-opacity=".5" />
                    <stop offset="100%" stop-color="#FFF" stop-opacity=".1" />
                  </linearGradient>
                </defs>
                ...
                <path fill="url(#logosCloudflareWorkers0)"
                  d="m38.624 1.95l17.699 31.93l-16.254 29.256a9.39 9.39 0 0 0 0 9.138l16.254 29.329l-17.699 31.929a18.8 18.8 0 0 1-7.946-7.477L2.505 77.115a18.85 18.85 0 0 1 0-18.783L30.678 9.391a18.8 18.8 0 0 1 7.946-7.44" />
                <path fill="url(#logosCloudflareWorkers1)"
                  d="M40.069 63.172a9.39 9.39 0 0 0 0 9.102l16.254 29.329l-17.699 31.929a18.8 18.8 0 0 1-7.946-7.477L2.505 77.115C.265 73.248 12.8 68.625 40.07 63.207z"
                  opacity=".7" />
                <path fill="url(#logosCloudflareWorkers2)"
                  d="M40.43 5.165L56.323 33.88l-2.637 4.587l-14.014-23.73c-4.046-6.61-10.222-3.179-17.952 10.185l1.156-1.986L30.678 9.39a18.8 18.8 0 0 1 7.874-7.44l1.842 3.214z"
                  opacity=".5" />
                <path fill="url(#logosCloudflareWorkers3)"
                  d="m119.53 9.39l28.174 48.942c3.359 5.78 3.359 13.003 0 18.782l-28.173 48.941a18.78 18.78 0 0 1-16.254 9.391H75.104l35.036-63.172a9.39 9.39 0 0 0 0-9.102L75.104 0h28.173a18.78 18.78 0 0 1 16.254 9.39" />
                <path fill="url(#logosCloudflareWorkers4)"
                  d="m101.832 135.23l-27.811.252l33.663-63.497a9.75 9.75 0 0 0 0-9.174L74.02 0h6.357l35.324 62.522a9.75 9.75 0 0 1-.036 9.68a5643 5643 0 0 0-22.647 39.73c-6.862 12.065-3.9 19.83 8.813 23.298" />
                <path fill="url(#logosCloudflareWorkers5)"
                ...
                <path fill="url(#logosCloudflareWorkers6)"
                  d="M107.684 64.58L71.854 0h3.25l35.036 63.172a9.39 9.39 0 0 1 0 9.102l-35.036 63.172h-3.25l35.83-64.58a6.48 6.48 0 0 0 0-6.285"
                  opacity=".6" />
                <path fill="url(#logosCloudflareWorkers7)"
                  d="M73.37 64.58L38.625 1.95c1.084-.577 2.384-1.01 3.612-1.372C49.893 14.339 61.2 35.216 76.188 63.172a9.39 9.39 0 0 1 0 9.102l-34.494 62.45c-1.228-.361-1.878-.614-3.034-1.156l34.675-62.666a6.48 6.48 0 0 0 0-6.285z"
                  opacity=".6" />
              </svg>
            </a>
          </div>
        ...
        <img src="/img/illustration/space-bird.svg" class="w-48 mt-12 mx-auto -scale-x-100">
      </div>
    </div>
    <!-- Features -->
    <div class="py-24 mx-auto max-w-7xl px-4">
      <h2 class="text-5xl">
        Get Started
      </h2>
      <p class="mb-8 mt-1 opacity-80">
        Follow these three steps to integrate Cloud Auth into your applications.
      </p>

      <div class="flex flex-col gap-6 mb-6 pt-8">
        <!-- CLI -->
        <div class="cli-block rounded-xl mt-12">
          <h3 class="text-4xl text-left mb-2">
          ...
          <div class="flex flex-col lg:flex-row items-center my-12 gap-6 vp-doc">
            <div class="flex flex-col max-w-xl text-left">
              <h3 class="text-2xl px-3 sm:px-0">
                Try an example app
              </h3>
              <p class="mt-1 mb-6 opacity-80 px-3 sm:px-0">
                Use the <code class="text-[var(--s)]">example</code> command to create an example application for your
        ...
        <div class="cli-block rounded-xl mt-12">
          ...
          <div class="flex flex-row items-center mt-4 mb-12 gap-6">
            <div class="flex-1">
              <img src="https://imagedelivery.net/9JPgw8SmnowT-UlbCrbUxw/30aef796-4df0-421c-a129-053a06d6f400/publichd"
    ...
    <div class="mx-auto max-w-4xl px-4 relative">
      <div class="mb-14 text-center">
        <h2 class="text-5xl">
          Flexible Pricing
        </h2>
        <div class="mt-2 text-xl">
          Get Started for Free. <br>Pay only for what you use.
        </div>
      </div>
      <Pricing />
    </div>

    <img src="/img/illustration/footer-bird-no-bg.svg">
  </div>
</template>
...
.auth-landing-page {
  width: 100%;
  background: linear-gradient(to bottom, #040407 0%, #281c43 56%, #ec5f62 100%);
}

.bg-stars {
  background: url('https://imagedelivery.net/9JPgw8SmnowT-UlbCrbUxw/a671b2ce-e05e-48d3-8c86-4fc1e934d800/public');
